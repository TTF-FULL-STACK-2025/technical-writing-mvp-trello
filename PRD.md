...
| **FR1.3** | Board Management | Complete CRUD for Boards (Creation, Modification, Archiving/Deletion). | Must | To be developed |
...
| **FR1.8** | Board Members | Adding, removing, and managing roles (`Owner`, `Editor`, `Viewer`). | Must | To be developed (Not present in the current stack) |
